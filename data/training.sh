...
node $EPARSER -l -t 'how many meters make 3 kilometer?' -L 'yes,QConv,meters,kilometer,3'
node $EPARSER -l -t 'how many meters make a kilometer?' -L 'yes,QConv,meters,kilometer,1'
node $EPARSER -l -t 'how many meters makes 3 kilometer?' -L 'yes,QConv,meters,kilometer,3'
node $EPARSER -l -t 'how many meters makes a kilometer?' -L 'yes,QConv,meters,kilometer,1'
